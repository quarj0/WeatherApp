...
# search bar
search_bar = PhotoImage(file="Images/search.png")
search_image = Label(image=search_bar)
search_image.place(x=20, y=20)

# text field
textfield = Entry(root, justify="center", width=17, font=("Times New Roman", 25, "bold"), background='#404040',
                  foreground='white')
...
root.iconbitmap('Images/weather icon.png')
...
def getWeather():
    try:
        ...
        api = "http://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=6a2cba9d48489b43b505644202086821"
...
humid = Label(root, text='HUMIDITY', font=('Helvetica', 15, 'bold'), bg='#1ab5ef', fg='white')
humid.place(x=180, y=380)

descript = Label(root, text='DESCRIPTION', font=('Helvetica', 15, 'bold'), bg='#1ab5ef', fg='white')
descript.place(x=330, y=380)

press = Label(root, text='PRESSURE', font=('Helvetica', 15, 'bold'), bg='#1ab5ef', fg='white')
